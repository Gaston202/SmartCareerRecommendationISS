...
@tool
def book_mentor_session(booking: dict) -> dict:
    """
...
@tool
def get_user_sessions(user_id: str, status: str = "scheduled") -> dict:
    """
...
@tool
def get_mentor_details(mentor_id: str) -> dict:
    """
